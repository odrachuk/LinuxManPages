 ...
 * from specific table
 */
public class DSCommandsByStartSymbolTask extends DataSourceAsyncTask {
    private static final String LOG_TAG = DSCommandsByStartSymbolTask.class.getName();
    private static final Logger LOGGER = Logger.getLogger(LOG_TAG);

    private final ManTable manTable;
    private final String startSymbol;

    public DSCommandsByStartSymbolTask(ManSQLiteOpenHelper dbHelper, ResponseListener<ManTableRecord> responseListener,
                                       ManTable manTable,
                                       String startSymbol) {
