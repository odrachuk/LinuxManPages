 ...
 ******************************************************************************/
package com.softsandr.man.ui.page.favorite;
 ...
 * This class used for...
 */
public class ManFavoriteFragment extends ListFragment {
    /**
     * Create a new instance of ManBrowserActivity, initialized to
     * show the file name.
     */
    public static ManFavoriteFragment newInstance() {
        return new ManFavoriteFragment();
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        setEmptyText(getString(R.string.no_favorite_items));
        // Setup divider
    ...
    public void onResume() {
        super.onResume();
        setListAdapter(new ManHistFavAdapter(getActivity(), PrefFavoritesUtils.getFavorites(getActivity())));
    }
